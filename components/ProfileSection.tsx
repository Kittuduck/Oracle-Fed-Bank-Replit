        ...
        <div className="min-h-screen bg-white dark:bg-[#0b0c10] text-[#333333] dark:text-slate-200 font-sans animate-fade-in transition-colors duration-300 relative">
            ...
            <div className="p-6 space-y-8 pb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* Dependents Card */}
                    <div className={`bg-white dark:bg-[#15161a] border rounded-xl p-4 shadow-federal dark:shadow-none transition-all ${editingDependents ? 'border-federalblue-500/50 ring-1 ring-federalblue-500/20 col-span-1 md:col-span-2' : 'border-[#E0E0E0] dark:border-slate-800'}`}>
                        <div className="flex justify-between items-start mb-3">
                            <div className="flex items-center gap-3">
